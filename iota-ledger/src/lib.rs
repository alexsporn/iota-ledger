...
) -> Result<LedgerHardwareWallet, APIError> {
...
impl LedgerHardwareWallet {
    ...
    pub fn is_app_open(&self) -> Result<bool, APIError> {
    ...
    pub fn bolos_open_app(&self) -> Result<(), APIError> {
    ...
    pub fn bolos_exit_app(&self) -> Result<(), APIError> {
    ...
    pub fn get_version(&self) -> Result<Version, APIError> {
    ...
    ) -> Result<PublicKeyResult, api::errors::APIError> {
    ...
    pub fn sign_transaction(
        ...
        transaction: Vec<u8>,
        objects: Vec<Vec<u8>>,
    ) -> Result<SignatureBytes, api::errors::APIError> {
